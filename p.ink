...
= intro_2
+ Abortion: Should pregnant women have the right to abort their children? -> intro_ab
+ Lying for Good Reason: Are people supposed to lie to others for good reasons? -> intro_ly
+ Corporal Punishment: Is it acceptable for parents to use physical discipline as a form of punishment? -> intro_pu
+ Privacy and Surveillance: Is it justifiable to install surveillance devices on your children’s devices for safety purposes? -> intro_pr
+ Transgender Athletics: Should transgenders be allowed to compete in sports based on their gender identity? -> intro_tr
+ [Start the game] -> 
...
++ [Not yet, I still want to know more about the dilemmas.] -> intro_2
++ [YES!] -> abortion
